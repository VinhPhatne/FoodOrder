...
export const getMenuItemsByRestaurantId = (reqData) => async (dispatch) => {
  ...
  try {
    ...
    console.log("menu Item by restaurantID", data);

    dispatch({ type: GET_MENU_ITEMS_BY_RESTAURANT_ID_SUCCESS, payload: data });
  } catch (error) {
    console.log("error getMenuItemsByRestaurantId", error);
    dispatch({
...
//         }
//       );
//       console.log("getAllIngredientsOfMenuItem", data);
...
export const updateMenuItemsAvailability =
  ...
  async (dispatch) => {
    ...
    try {
      ...
      console.log("updateMenuItemsAvailability", data);
